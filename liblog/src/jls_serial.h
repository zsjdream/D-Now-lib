...
#define log_serial_write_txbuf(base, val)  reg_writec( base, SERIAL_TXBUF, val )

#define log_serial_write_ie(base, val)  reg_writew_l( base, SERIAL_ICTL, val )



#define log_serial_set_ie(base, val)  reg_setw_l( base, SERIAL_ICTL, val )

#define log_serial_clear_ie(base, val)  reg_clearw_l( base, SERIAL_ICTL, val )

#define log_serial_read_ie(base)  reg_readw_l( base, SERIAL_ICTL )

#define log_serial_read_ifg(base)  reg_readw_h( base, SERIAL_ICTL)

#define log_serial_read_rxbuf(base)  reg_readc( base, SERIAL_RXBUF)
