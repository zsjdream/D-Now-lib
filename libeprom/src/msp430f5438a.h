...
#define SYSRSTIV_PSSKEY    (0x0020u)    /* SYSRSTIV : PSSKEY violation */
...
/* TAxCTL Control Bits */
#define ID1_L               (0x0080u)  /* Timer A clock input divider 1 */
#define ID0_L               (0x0040u)  /* Timer A clock input divider 0 */
#define MC1_L               (0x0020u)  /* Timer A mode control 1 */
#define MC0_L               (0x0010u)  /* Timer A mode control 0 */
#define TACLR_L             (0x0004u)  /* Timer A counter clear */
#define TAIE_L              (0x0002u)  /* Timer A counter interrupt enable */
#define TAIFG_L             (0x0001u)  /* Timer A counter interrupt flag */

/* TAxCTL Control Bits */
#define TASSEL1_H           (0x0002u)  /* Timer A clock source select 0 */
#define TASSEL0_H           (0x0001u)  /* Timer A clock source select 1 */
...
/* TAxCCTLx Control Bits */
#define OUTMOD2_L           (0x0080u)  /* Output mode 2 */
#define OUTMOD1_L           (0x0040u)  /* Output mode 1 */
#define OUTMOD0_L           (0x0020u)  /* Output mode 0 */
#define CCIE_L              (0x0010u)  /* Capture/compare interrupt enable */
#define CCI_L               (0x0008u)  /* Capture input signal (read) */
#define OUT_L               (0x0004u)  /* PWM Output signal if output mode 0 */
#define COV_L               (0x0002u)  /* Capture/compare overflow flag */
#define CCIFG_L             (0x0001u)  /* Capture/compare interrupt flag */

/* TAxCCTLx Control Bits */
#define CM1_H               (0x0080u)  /* Capture mode 1 */
#define CM0_H               (0x0040u)  /* Capture mode 0 */
#define CCIS1_H             (0x0020u)  /* Capture input select 1 */
#define CCIS0_H             (0x0010u)  /* Capture input select 0 */
#define SCS_H               (0x0008u)  /* Capture sychronize */
#define SCCI_H              (0x0004u)  /* Latched capture signal (read) */
#define CAP_H               (0x0001u)  /* Capture mode: 1 /Compare mode : 0 */
...
/* TAxEX0 Control Bits */
#define TAIDEX0_L           (0x0001u)  /* Timer A Input divider expansion Bit: 0 */
#define TAIDEX1_L           (0x0002u)  /* Timer A Input divider expansion Bit: 1 */
#define TAIDEX2_L           (0x0004u)  /* Timer A Input divider expansion Bit: 2 */
...
/* TBxCTL Control Bits */
#define TBCLR_L             (0x0004u)  /* Timer0_B7 counter clear */
#define TBIE_L              (0x0002u)  /* Timer0_B7 interrupt enable */
#define TBIFG_L             (0x0001u)  /* Timer0_B7 interrupt flag */

/* TBxCTL Control Bits */
#define TBCLGRP1_H          (0x0040u)  /* Timer0_B7 Compare latch load group 1 */
#define TBCLGRP0_H          (0x0020u)  /* Timer0_B7 Compare latch load group 0 */
#define CNTL1_H             (0x0010u)  /* Counter lenght 1 */
#define CNTL0_H             (0x0008u)  /* Counter lenght 0 */
#define TBSSEL1_H           (0x0002u)  /* Clock source 1 */
#define TBSSEL0_H           (0x0001u)  /* Clock source 0 */
...
/* TBxCCTLx Control Bits */
#define CLLD1_H             (0x0004u)  /* Compare latch load source 1 */
#define CLLD0_H             (0x0002u)  /* Compare latch load source 0 */
...
/* TBxEX0 Control Bits */
#define TBIDEX0_L           (0x0001u)   /* Timer0_B7 Input divider expansion Bit: 0 */
#define TBIDEX1_L           (0x0002u)   /* Timer0_B7 Input divider expansion Bit: 1 */
#define TBIDEX2_L           (0x0004u)   /* Timer0_B7 Input divider expansion Bit: 2 */
...
#define DCOR                (0x0002u)    /* DCO External Resistor Select */
//#define RESERVED            (0x0004u)    /* RESERVED */
//#define RESERVED            (0x0008u)    /* RESERVED */
...
#define DCOR_L              (0x0002u)    /* DCO External Resistor Select */
//#define RESERVED            (0x0004u)    /* RESERVED */
//#define RESERVED            (0x0008u)    /* RESERVED */
